...
* #### [The beacon does not seem to be working?](#The beacon does not seem to be working?)

* #### [Do you have any other model of beacons which are smaller in size? Do you sell USB beacons?](#Do you have any other model of beacons which are smaller in size? Do you sell USB beacons?)

* #### [Can I change the UUID of the beacon?](#Can I change the UUID of the beacon?)

* #### [Are Beaconstac beacons weather proof?](#Are Beaconstac beacons weather proof?)

* #### [Can I detect beacons if my phone’s bluetooth is off?](#Can I detect beacons if my phone’s bluetooth is off?)

* #### [How do I monitor the health of all my beacons?](#How do I monitor the health of all my beacons?)

* #### [Can I change the UUID/major/minor using Android app?](#Can I change the UUID/major/minor using Android app?)

* #### [What is the broadcast range and frequency (advertising interval) of the beacons?](#What is the broadcast range and frequency (advertising interval) of the beacons?)

* #### [What is the optimum advertising interval that I can set?](#What is the optimum advertising interval that I can set?)

* #### [Can I set different proximity range/distance for different beacons? e.g. some at 3m and some at 1m?](#Can I set different proximity range/distance for different beacons? e.g. some at 3m and some at 1m?)

* #### [What is the battery life of Beaconstac beacons?](#What is the battery life of Beaconstac beacons?)

* #### [How can I reset my password?](#How can I reset my password?)

* #### [My app could not detect the Beaconstac Starter kit beacons?](#My app could not detect the Beaconstac Starter kit beacons?)

* #### [How can I change the “Rules” icons in the Beaconstac app?](#How can I change the “Rules” icons in the Beaconstac app?)

* #### [As a mall owner, can I give access to all my brands into your portal so that the brands can create their own campaigns? OR Is it possible to create sub accounts in your admin console to be shared with different members?](#As a mall owner, can I give access to all my brands into your portal so that the brands can create their own campaigns? OR Is it possible to create sub accounts in your admin console to be shared with different members?)

* #### [What is a geofence, how do I enable it?](#What is a geofence, how do I enable it?)

* #### [How can I customize the notification message when a geofence is entered?](#How can I customize the notification message when a geofence is entered?)

* #### [How can I send a push notification to the app?](#How can I send a push notification to the app?)

* #### [What is offered under Beaconstac analytics?](#What is offered under Beaconstac analytics?)

* #### [What different platforms are supported by your SDK?](#What different platforms are supported by your SDK?)

* #### [How can I view cards with your SDK?](#How can I view cards with your SDK?)

* #### [Can we use our own dashboard and leverage your APIs or do we need to only use your dashboard?](#Can we use our own dashboard and leverage your APIs or do we need to only use your dashboard?)

* #### [Can we integrate data from other enterprise backends into Beaconstac?](#Can we integrate data from other enterprise backends into Beaconstac?)

* #### [Is there frequency capping on the marketing?](#Is there frequency capping on the marketing?)


* #### [How to find out beacon health status and battery level?](#How to find out beacon health status and battery level?)

* #### [Can I send lock-screen notifications to my users?](#Can I send lock-screen notifications to my users?)

* #### [I already have an app. Can I integrate beaconstac into it?](#I already have an app. Can I integrate beaconstac into it?)
